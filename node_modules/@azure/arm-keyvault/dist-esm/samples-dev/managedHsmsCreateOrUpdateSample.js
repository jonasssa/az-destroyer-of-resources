...
function createANewManagedHsmPoolOrUpdateAnExistingManagedHsmPool() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedHsms.beginCreateOrUpdateAndWait(resourceGroupName, name, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=managedHsmsCreateOrUpdateSample.js.map